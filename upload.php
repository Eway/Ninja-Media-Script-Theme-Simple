...
<div id="wrap" class="upload">
     ...
     <form method="POST" action="<?= URL::to('media') ?>" id="media-form" accept-charset="UTF-8" file="1" enctype="multipart/form-data">
        ...
        <br />
        <input class="btn primary_color_background" type="submit" value="<?= Lang::get('lang.submit') ?>">
        <br />
        <br />
...
<script type="text/javascript" src="<?= URL::to('/') ?>/content/themes/simple/assets/js/jquery.tagsinput.js"></script>
